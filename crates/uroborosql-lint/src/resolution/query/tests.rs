...
fn accepts_bounded_clauses_and_implicit_output_aliases() {
    for sql in [
        ...
        "SELECT nmae FROM users LIMIT ALL",
        "SELECT nmae FROM users FETCH FIRST ROW ONLY",
        "SELECT nmae FROM users FETCH FIRST ROWS ONLY",
        "SELECT nmae FROM users FETCH NEXT ROW ONLY",
        "SELECT nmae FROM users FETCH NEXT ROWS ONLY",
        "SELECT nmae FROM users WHERE agge > 1 LIMIT ALL",
        "SELECT nmae FROM users OFFSET 2 ROWS FETCH NEXT ROW ONLY",
